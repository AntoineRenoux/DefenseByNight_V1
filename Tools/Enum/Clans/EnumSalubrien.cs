...
namespace Tools
{
    public static class EnumSalubrien
    {
        public static readonly string CLAN_SALUBRIEN = "CLAN_SALUBRIEN";
        public static readonly string CLAN_SALUBRIEN_NAME = "CLAN_SALUBRIEN_NAME";
