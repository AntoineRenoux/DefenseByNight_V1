...
namespace Tools
{
    public static class EnumGargouille
    {
        public static readonly string CLAN_GRAGOUILLE = "CLAN_GRAGOUILLE";
        public static readonly string CLAN_GRAGOUILLE_NAME = "CLAN_GRAGOUILLE_NAME";
