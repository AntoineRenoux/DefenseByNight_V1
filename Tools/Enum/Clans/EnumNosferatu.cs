...
namespace Tools
{
    public static class EnumNosferatu
    {
        public static readonly string CLAN_NOSFERATU = "CLAN_NOSFERATU";
        public static readonly string CLAN_NOSFERATU_NAME = "CLAN_NOSFERATU_NAME";
