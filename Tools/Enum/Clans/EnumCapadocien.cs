...
namespace Tools
{
    public static class EnumCapadocien
    {
        public static readonly string CLAN_CAPPADOCIEN = "CLAN_CAPPADOCIEN";
        public static readonly string CLAN_CAPPADOCIEN_NAME = "CLAN_CAPPADOCIEN_NAME";
