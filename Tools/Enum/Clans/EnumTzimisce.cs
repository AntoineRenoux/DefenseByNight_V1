...
namespace Tools
{
    public static class EnumTzimisce
    {
        public static readonly string CLAN_TZIMISCE = "CLAN_TZIMISCE";
        public static readonly string CLAN_TZIMISCE_NAME = "CLAN_TZIMISCE_NAME";
