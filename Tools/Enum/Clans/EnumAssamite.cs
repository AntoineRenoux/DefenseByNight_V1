...
namespace Tools
{
    public static class EnumAssamite
    {
        public static readonly string CLAN_ASSAMITE = "CLAN_ASSAMITE";
        public static readonly string CLAN_ASSAMITE_NAME = "CLAN_ASSAMITE_NAME";
