...
namespace Tools
{
    public static class EnumToreador
    {
        public static readonly string CLAN_TOREADOR = "CLAN_TOREADOR";
        public static readonly string CLAN_TOREADOR_NAME = "CLAN_TOREADOR_NAME";
