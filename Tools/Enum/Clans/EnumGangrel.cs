...
namespace Tools
{
    public static class EnumGangrel
    {
        public static readonly string CLAN_GANGREL = "CLAN_GANGREL";
        public static readonly string CLAN_GANGREL_NAME = "CLAN_GANGREL_NAME";
