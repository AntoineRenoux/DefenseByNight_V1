...
namespace Tools
{
    public static class EnumMalkavian
    {
        public static readonly string CLAN_MALKAVIAN = "CLAN_MALKAVIAN";
        public static readonly string CLAN_MALKAVIAN_NAME = "CLAN_MALKAVIAN_NAME";
