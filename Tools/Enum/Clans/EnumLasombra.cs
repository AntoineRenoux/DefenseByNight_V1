...
namespace Tools
{
    public static class EnumLasombra
    {
        public static readonly string CLAN_LASOMBRA = "CLAN_LASOMBRA";
        public static readonly string CLAN_LASOMBRA_NAME = "CLAN_LASOMBRA_NAME";
