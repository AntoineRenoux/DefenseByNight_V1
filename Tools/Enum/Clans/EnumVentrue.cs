...
namespace Tools
{
    public static class EnumVentrue
    {
        public static readonly string CLAN_VENTRUE = "CLAN_VENTRUE";
        public static readonly string CLAN_VENTRUE_NAME = "CLAN_VENTRUE_NAME";
