    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DAL.DbnContext>
    {
        ...
        public static class AffiliateInitializer
        {
            public static void Initializer(DbnContext context)
            {
                ...
                new List<Traduction>
                {
                     new Traduction{LCID = 1036, Key = EnumAffiliate.CAMARILLA, Text = "Camarilla"},
                     new Traduction{LCID = 1036, Key = EnumAffiliate.SABBAT, Text = "Sabbat"},
        ...
        private static class AnimalismInitializer
        {
            ...
            {
                new Power { Level = 1, PowerName = EnumAnimalism.ANIMALISM_POWER_1_NAME, Description = EnumAnimalism.ANIMALISM_POWER_1_DESCRIPTION, System = EnumAnimalism.ANIMALISM_POWER_1_SYSTEM, Focus = focus[3], FocusEffect = EnumAnimalism.ANIMALISM_POWER_1_FOCUS_DESCRIPTION, ExceptionalSuccess = EnumAnimalism.ANIMALISM_POWER_1_EXCEPTIONALSUCCESS, DisciplineName = EnumAnimalism.ANIMALISM_NAME },
                new Power { Level = 2, PowerName = EnumAnimalism.ANIMALISM_POWER_2_NAME, Description = EnumAnimalism.ANIMALISM_POWER_2_DESCRIPTION, System = EnumAnimalism.ANIMALISM_POWER_2_SYSTEM, Focus = focus[3], FocusEffect = EnumAnimalism.ANIMALISM_POWER_2_FOCUS_DESCRIPTION, ExceptionalSuccess = EnumAnimalism.ANIMALISM_POWER_2_EXCEPTIONALSUCCESS, DisciplineName = EnumAnimalism.ANIMALISM_NAME },
                new Power { Level = 3, PowerName = EnumAnimalism.ANIMALISM_POWER_3_NAME, Description = EnumAnimalism.ANIMALISM_POWER_3_DESCRIPTION, System = EnumAnimalism.ANIMALISM_POWER_3_SYSTEM, Focus = focus[4], FocusEffect = EnumAnimalism.ANIMALISM_POWER_3_FOCUS_DESCRIPTION, ExceptionalSuccess = EnumAnimalism.ANIMALISM_POWER_3_EXCEPTIONALSUCCESS, DisciplineName = EnumAnimalism.ANIMALISM_NAME },
                new Power { Level = 4, PowerName = EnumAnimalism.ANIMALISM_POWER_4_NAME, Description = EnumAnimalism.ANIMALISM_POWER_4_DESCRIPTION, System = EnumAnimalism.ANIMALISM_POWER_4_SYSTEM, Focus = focus[4], FocusEffect = EnumAnimalism.ANIMALISM_POWER_4_FOCUS_DESCRIPTION, ExceptionalSuccess = EnumAnimalism.ANIMALISM_POWER_4_EXCEPTIONALSUCCESS, DisciplineName = EnumAnimalism.ANIMALISM_NAME },
                new Power { Level = 5, PowerName = EnumAnimalism.ANIMALISM_POWER_5_NAME, Description = EnumAnimalism.ANIMALISM_POWER_5_DESCRIPTION, System = EnumAnimalism.ANIMALISM_POWER_5_SYSTEM, Focus = focus[4], FocusEffect = EnumAnimalism.ANIMALISM_POWER_5_FOCUS_DESCRIPTION, ExceptionalSuccess = EnumAnimalism.ANIMALISM_POWER_5_EXCEPTIONALSUCCESS, DisciplineName = EnumAnimalism.ANIMALISM_NAME }
            };
