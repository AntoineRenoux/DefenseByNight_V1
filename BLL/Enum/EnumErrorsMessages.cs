namespace BLL.Enum
{
    public static class EnumErrorsMessages
    {
        ...
        public readonly static string ERR_FIRSTNAME_TO_LONG = "ERR_FIRSTNAME_TO_LONG";

        public readonly static string ERR_LASTNAME_MISSING = "ERR_LASTNAME_MISSING";
        public readonly static string ERR_LASTNAME_TO_LONG = "ERR_LASTNAME_TO_LONG";

        public readonly static string ERR_ALIAS_MISSING = "ERR_ALIAS_MISSING";
        public readonly static string ERR_ALIAS_TO_LONG = "ERR_ALIAS_TO_LONG";

        public readonly static string ERR_EMAIL_MISSING = "ERR_EMAIL_MISSING";
        public readonly static string ERR_EMAIL_UNCORRECT = "ERR_EMAIL_UNCORRECT";
        ...
        public readonly static string ERR_PASSWORD_NOT_MATCHING = "ERR_PASSWORD_NOT_MATCHING";
